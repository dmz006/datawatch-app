...
| BL388 | ✅ Android Auto Messaging Compliance — conversation-thread body on session/PRD/story/task detail screens; MessagingStyle notifications; category IOT → MESSAGING; PRD voice spec update; ADR-0049. Shipped v1.16.0. | v1.16.0 |

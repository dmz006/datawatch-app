...
class RestTransportTest {
    ...
    @Test
    fun noTokenProviderOmitsAuthorizationHeader() =
        runTest {
            val client =
                HttpClient(OkHttp) {
                    install(ContentNegotiation) { json(RestTransport.DefaultJson) }
    ...
    @Test
    fun listSessionsDeserializesHappyPath() =
        runTest {
    ...
    @Test
    fun networkUnreachableMapsToUnreachable() =
        runTest {
            server.shutdown()
            val res = transport.listSessions()
            assertTrue(res.isFailure)
    ...
    @Test
    fun startSessionReturnsIdFromResponse() =
        runTest {
    ...
    @Test
    fun unregisterDeviceCallsDeleteWithId() =
        runTest {
    ...
    @Test
    fun statsDeserializesAllFields() =
        runTest {
            server.enqueue(
                jsonResponse(
                    """
    ...
    @Test
    fun renameSessionPostsIdAndName() =
        runTest {
    ...
    @Test
    fun restartSessionReturnsSessionDomain() =
        runTest {
            server.enqueue(
                jsonResponse(
                    """
    ...
    @Test
    fun deleteSessionPostsSingleId() =
        runTest {
            server.enqueue(jsonResponse("""{"status":"ok"}"""))
    ...
    @Test
    fun deleteSessionsBulkPostsIdArray() =
        runTest {
            server.enqueue(jsonResponse("""{"status":"ok"}"""))
    ...
    @Test
    fun deleteSession404MapsToNotFound() =
        runTest {
    ...
    @Test
    fun fetchCert404MapsToNotFound() =
        runTest {
    ...
    @Test
    fun setActiveBackend404MapsToNotFound() =
        runTest {
            server.enqueue(MockResponse().setResponseCode(404))
            val res = transport.setActiveBackend("ollama")
            assertTrue(res.exceptionOrNull() is TransportError.NotFound, "${res.exceptionOrNull()}")
    ...
    @Test
    fun listAlertsReturnsListPlusUnreadCount() =
        runTest {
            server.enqueue(
                jsonResponse(
                    """
    ...
    @Test
    fun markAlertReadSingleEmitsOnlyId() =
        runTest {
            server.enqueue(jsonResponse("""{"status":"ok"}"""))
    ...
    @Test
    fun markAlertReadAllEmitsAllTrue() =
        runTest {
            server.enqueue(jsonResponse("""{"status":"ok"}"""))
    ...
    @Test
    fun fetchOutputReturnsPlainTextAndPassesQueryParams() =
        runTest {
            val plain = "line 1\nline 2\nline 3\n"
            server.enqueue(
                MockResponse()
    ...
    @Test
    fun createSchedulePostsBodyAndReturnsDomain() =
        runTest {
            server.enqueue(
                jsonResponse(
                    """
    ...
    @Test
    fun browseFilesDefaultPathOmitsQuery() =
        runTest {
            server.enqueue(
                jsonResponse(
                    """
    ...
    @Test
    fun browseFilesWithPathPassesQueryParam() =
        runTest {
            server.enqueue(
    ...
    @Test
    fun saveCommandPostsNameAndBody() =
        runTest {
            server.enqueue(jsonResponse("""{"status":"ok"}"""))
    ...
    @Test
    fun deleteCommandPassesNameAsQueryParam() =
        runTest {
            server.enqueue(jsonResponse("""{"status":"ok"}"""))

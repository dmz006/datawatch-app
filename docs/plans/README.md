...
| BL20 | Saved command library (`/api/commands` CRUD) | **Pulled into v0.12** — Settings → Saved commands card + New Session "From library" dropdown. Will move to Completed backlog when v0.12 ships. |

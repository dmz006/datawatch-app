...
```bash
# Phone (debug APK from the v0.11.0 release)
adb install -r datawatch-0.11.0.apk

# Wear OS — requires the watch to be paired to this phone or to have debug
# bridge enabled over Wi-Fi. See below.
adb -s <watch-serial> install -r datawatch-wear-0.11.0.apk
```

...
class SessionStatusViewModelTest {
    ...
    @Test
    fun `fetchStatus populates board on success`() =
    ...
    @Test
    fun `fetchStatus sets error on failure`() =
        runTest(testDispatcher) {
            val (t, r) = fakeResolver()
    ...
    @Test
    fun `fetchStatus no-ops when no profile`() =
        runTest(testDispatcher) {
    ...
    @Test
    fun `stopPolling cancels in-flight poll`() =
        runTest(testDispatcher) {
            val (t, r) = fakeResolver()
    ...
    @Test
    fun `board fields reflect tests card data`() =
        runTest(testDispatcher) {
            val (t, r) = fakeResolver()
